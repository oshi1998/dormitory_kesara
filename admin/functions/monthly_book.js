function read() {
    ...
    $.ajax({
        method: "post",
        url: "api/monthly_book/readByStatus1.php",
    }).done(function (res) {
            ...
            data_html += `
                <tr>
                    <td>
                        ...
                        ห้อง: ${element['monthly_room_id']} <br>
                        กำหนดย้ายของเข้า: ${element['schedule_move_in']} <br>
...
function readByStatus2() {
    ...
    $.ajax({
        method: "post",
        url: "api/monthly_book/readByStatus2.php",
    }).done(function (res) {
...
function readByStatus3() {
    ...
    $.ajax({
        method: "post",
        url: "api/monthly_book/readByStatus3.php",
    }).done(function (res) {
...
function readByStatus4() {
    ...
    $.ajax({
        method: "post",
        url: "api/monthly_book/readByStatus4.php",
    }).done(function (res) {
        ...
        res.data.forEach(element => {
            data_html += `
                <tr>
                    ...
                    <td>${element['status']}</td>
                    <td>
                        <button class="btn btn-success" onclick="moveIn('${element['id']}')">
                            <i class="fas fa-check"></i>
                            ย้ายเข้า
                        </button>
                        <button class="btn btn-danger" onclick="refuse('${element['id']}')">
...
function readByStatus5() {
    ...
    $.ajax({
        method: "post",
        url: "api/monthly_book/readByStatus5.php",
    }).done(function (res) {
        ...
        res.data.forEach(element => {
            data_html += `
                <tr>
                    ...
                    ย้ายเข้าเมื่อ: ${element['move_in_date']}
                    </td>
                    <td>
                        <button class="btn btn-success" onclick="moveOut('${element['id']}')">
                            <i class="fas fa-check"></i>
                            ย้ายออก
                        </button>
                    </td>
...
function readByStatus6() {
    ...
    $.ajax({
        method: "post",
        url: "api/monthly_book/readByStatus6.php",
    }).done(function (res) {
        ...
        res.data.forEach(element => {
            data_html += `
                <tr>
                    ...
                    ย้ายเข้าเมื่อ: ${element['move_in_date']} <br>
                    ย้ายออกเมื่อ: ${element['move_out_date']}
                    </td>
                </tr>
            `;
        });
...
function readByStatus7() {
    ...
    $.ajax({
        method: "post",
        url: "api/monthly_book/readByStatus7.php",
    }).done(function (res) {
...
function countNotification() {
    $.ajax({
        method: "get",
        url: "api/monthly_book/count_notification.php",
    }).done(function (res) {
        console.log(res);
...
function approve(id) {
    swal({
        ...
        if (willDelete) {
            $.ajax({
                type: "get",
                url: "api/monthly_book/approve.php",
                data: {
                    "id": id
                }
            }).done(function (res) {
...
function approveDeposit(id) {
    swal({
        ...
        if (willDelete) {
            $.ajax({
                type: "get",
                url: "api/monthly_book/approve_deposit.php",
                data: {
                    "id": id
                }
            }).done(function (res) {
...
function moveIn(id) {
    swal({
        title: "ยืนยันการย้ายเข้าหมายเลขจอง " + id + " ?",
        text: "หากดำเนินการไปแล้ว จะไม่สามารถกลับมาแก้ไขได้!",
        icon: "warning",
        buttons: true,
    }).then((willDelete) => {
        if (willDelete) {
            $.ajax({
                type: "get",
                url: "api/monthly_book/move_in.php",
                data: {
                    "id": id
                }
            }).done(function (res) {
...
function moveOut(id) {
    swal({
        title: "ยืนยันการย้ายออกหมายเลขจอง " + id + " ?",
        text: "หากดำเนินการไปแล้ว จะไม่สามารถกลับมาแก้ไขได้!",
        icon: "warning",
        buttons: true,
    }).then((willDelete) => {
        if (willDelete) {
            $.ajax({
                type: "get",
                url: "api/monthly_book/move_out.php",
                data: {
                    "id": id
                }
            }).done(function (res) {
...
function submitRefuse() {
    $.ajax({
        type: "post",
        url: "api/monthly_book/refuse.php",
