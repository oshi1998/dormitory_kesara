...
<head>
    ...
    <title>ข้อมูลจองห้องพักรายเดือน | ระบบจัดการข้อมูลหลังบ้าน DORMITORY KESARA</title>
    <!-- Sweetalert -->
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">ข้อมูลจองห้องพักรายเดือน</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">แดชบอร์ด</a></li>
                                <li class="breadcrumb-item active">ข้อมูลจองห้องพักรายเดือน</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <div class="card-header">
                                    <h3 class="card-title">
                                        ...
                                        <button type="button" class="btn btn-outline-success" id="btnStatus6" onclick="readByStatus6()">
                                            <span>เสร็จสิ้น</span>
                                            <span class="badge badge-danger" id="status6"></span>
                                        </button>
                                        <button type="button" class="btn btn-outline-success" id="btnStatus7" onclick="readByStatus7()">
                                            <span>ยกเลิก</span>
                                            <span class="badge badge-danger" id="status7"></span>
                                        </button>
                                    </h3>
                                </div>
                                <!-- /.card-header -->
